      ...
      <div className="max-w-6xl mx-auto py-24">
        ...
        >
          {metrics.map((metric, index) => (
            ...
            >
              <div className="relative overflow-hidden rounded-xl p-8 border transition-all duration-300 bg-black/40 border-[#252525] hover:border-[#00d9ff] hover:shadow-[0_0_30px_rgba(0,217,255,0.15)] hover:-translate-y-1">
                ...
                <div className="relative z-10 text-center">
                  {/* Large number in cyan */}
                  <div className="text-6xl font-bold mb-3 text-[#00d9ff] transition-all duration-300 group-hover:scale-110 font-mono">
                    {metric.number}
                  </div>
