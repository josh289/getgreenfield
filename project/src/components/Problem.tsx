      ...
      <div ref={problemRef} className="max-w-6xl mx-auto">
        <div className="animate-on-scroll opacity-0 translate-y-8 transition-all duration-700">
          <SectionTitle 
            ...
            subtitle="Traditional two-week timeboxes can't keep up with AI-augmented teams. cntxtl's Relay Engine powers continuous, context-driven work that evolves as you do."
            align="center"
            accent="purple"
          />
        </div>
